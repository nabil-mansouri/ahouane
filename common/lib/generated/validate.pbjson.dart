...
const ValidationResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fieldErrors', '3': 2, '4': 3, '5': 11, '6': '.validate.ValidationResult.FieldErrorsEntry', '10': 'fieldErrors'},
  ],
  '3': const [ValidationResult_FieldErrorsEntry$json],
};

@$core.Deprecated('Use validationResultDescriptor instead')
const ValidationResult_FieldErrorsEntry$json = const {
  '1': 'FieldErrorsEntry',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.validate.ValidationResult', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `ValidationResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validationResultDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use validationRequestDescriptor instead')
const ValidationRequest$json = const {
  '1': 'ValidationRequest',
  '2': const [
    const {'1': 'body', '3': 1, '4': 2, '5': 11, '6': '.google.protobuf.Any', '10': 'body'},
    const {'1': 'customRules', '3': 2, '4': 3, '5': 11, '6': '.validate.ValidationRequest.CustomRulesEntry', '10': 'customRules'},
    const {'1': 'recursive', '3': 3, '4': 1, '5': 8, '10': 'recursive'},
    const {'1': 'stopFirst', '3': 4, '4': 1, '5': 8, '10': 'stopFirst'},
  ],
  '3': const [ValidationRequest_CustomRulesEntry$json],
};

@$core.Deprecated('Use validationRequestDescriptor instead')
const ValidationRequest_CustomRulesEntry$json = const {
  '1': 'CustomRulesEntry',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.validate.FieldRules', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `ValidationRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validationRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use serverValidationConfigDescriptor instead')
const ServerValidationConfig$json = const {
  '1': 'ServerValidationConfig',
  '2': const [
    const {'1': 'serviceConfig', '3': 1, '4': 1, '5': 11, '6': '.ChannelServiceConfig', '10': 'serviceConfig'},
    const {'1': 'intercept', '3': 2, '4': 1, '5': 9, '10': 'intercept'},
    const {'1': 'recursive', '3': 3, '4': 1, '5': 8, '10': 'recursive'},
    const {'1': 'stopFirst', '3': 4, '4': 1, '5': 8, '10': 'stopFirst'},
  ],
};

/// Descriptor for `ServerValidationConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List serverValidationConfigDescriptor = $convert.base64Decode('ChZTZXJ2ZXJWYWxpZGF0aW9uQ29uZmlnEjsKDXNlcnZpY2VDb25maWcYASABKAsyFS5DaGFubmVsU2VydmljZUNvbmZpZ1INc2VydmljZUNvbmZpZxIcCglpbnRlcmNlcHQYAiABKAlSCWludGVyY2VwdBIcCglyZWN1cnNpdmUYAyABKAhSCXJlY3Vyc2l2ZRIcCglzdG9wRmlyc3QYBCABKAhSCXN0b3BGaXJzdA==');
