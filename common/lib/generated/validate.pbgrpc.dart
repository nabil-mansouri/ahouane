...
class ValidationServiceClient extends $grpc.Client {
  static final _$validate =
      $grpc.ClientMethod<$1.ValidationRequest, $1.ValidationResult>(
          '/validate.ValidationService/validate',
          ($1.ValidationRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.ValidationResult.fromBuffer(value));
  static final _$isValid =
      $grpc.ClientMethod<$1.ValidationRequest, $2.BoolValue>(
          '/validate.ValidationService/isValid',
          ($1.ValidationRequest value) => value.writeToBuffer(),
  ...
  $grpc.ResponseFuture<$1.ValidationResult> validate(
      $1.ValidationRequest request,
      {$grpc.CallOptions options}) {
    return $createUnaryCall(_$validate, request, options: options);
  }

  $grpc.ResponseFuture<$2.BoolValue> isValid($1.ValidationRequest request,
      {$grpc.CallOptions options}) {
    return $createUnaryCall(_$isValid, request, options: options);
  }
}
...
abstract class ValidationServiceBase extends $grpc.Service {
  ...
  $async.Future<$2.BoolValue> isValid_Pre($grpc.ServiceCall call,
      $async.Future<$1.ValidationRequest> request) async {
    return isValid(call, await request);
  }

  $async.Future<$1.ValidationResult> validate(
      $grpc.ServiceCall call, $1.ValidationRequest request);
  $async.Future<$2.BoolValue> isValid(
      $grpc.ServiceCall call, $1.ValidationRequest request);
}
