...
class ValidationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'validate'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors')
    ..m<$core.String, ValidationResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldErrors', protoName: 'fieldErrors', entryClassName: 'ValidationResult.FieldErrorsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ValidationResult.create, packageName: const $pb.PackageName('validate'))
  ...
  factory ValidationResult({
    ...
    $core.Map<$core.String, ValidationResult> fieldErrors,
  }) {
    ...
    if (fieldErrors != null) {
      _result.fieldErrors.addAll(fieldErrors);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, ValidationResult> get fieldErrors => $_getMap(1);
}

class ValidationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'validate'), createEmptyInstance: create)
    ..aQM<$3.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'body', subBuilder: $3.Any.create)
    ..m<$core.String, FieldRules>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customRules', protoName: 'customRules', entryClassName: 'ValidationRequest.CustomRulesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: FieldRules.create, packageName: const $pb.PackageName('validate'))
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recursive')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stopFirst', protoName: 'stopFirst')
  ;

  ValidationRequest._() : super();
  factory ValidationRequest({
    $3.Any body,
    $core.Map<$core.String, FieldRules> customRules,
    $core.bool recursive,
    $core.bool stopFirst,
  }) {
    final _result = create();
    ...
    if (customRules != null) {
      _result.customRules.addAll(customRules);
    }
    if (recursive != null) {
      _result.recursive = recursive;
    }
    if (stopFirst != null) {
      _result.stopFirst = stopFirst;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidationRequest copyWith(void Function(ValidationRequest) updates) => super.copyWith((message) => updates(message as ValidationRequest)) as ValidationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.Any get body => $_getN(0);
  @$pb.TagNumber(1)
  set body($3.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBody() => $_has(0);
  @$pb.TagNumber(1)
  void clearBody() => clearField(1);
  @$pb.TagNumber(1)
  $3.Any ensureBody() => $_ensure(0);

  @$pb.TagNumber(2)
  $core.Map<$core.String, FieldRules> get customRules => $_getMap(1);

  @$pb.TagNumber(3)
  $core.bool get recursive => $_getBF(2);
  @$pb.TagNumber(3)
  set recursive($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.bool get stopFirst => $_getBF(3);
  @$pb.TagNumber(4)
  set stopFirst($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasStopFirst() => $_has(3);
  @$pb.TagNumber(4)
  void clearStopFirst() => clearField(4);
}

class ServerValidationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerValidationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'validate'), createEmptyInstance: create)
    ..aOM<$0.ChannelServiceConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceConfig', protoName: 'serviceConfig', subBuilder: $0.ChannelServiceConfig.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intercept')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recursive')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stopFirst', protoName: 'stopFirst')
    ..hasRequiredFields = false
  ;

  ServerValidationConfig._() : super();
  factory ServerValidationConfig({
  ...
  factory ServerValidationConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ServerValidationConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ServerValidationConfig clone() => ServerValidationConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ServerValidationConfig copyWith(void Function(ServerValidationConfig) updates) => super.copyWith((message) => updates(message as ServerValidationConfig)) as ServerValidationConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ServerValidationConfig create() => ServerValidationConfig._();
  ServerValidationConfig createEmptyInstance() => create();
  static $pb.PbList<ServerValidationConfig> createRepeated() => $pb.PbList<ServerValidationConfig>();
  @$core.pragma('dart2js:noInline')
  static ServerValidationConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ServerValidationConfig>(create);
  static ServerValidationConfig _defaultInstance;

  @$pb.TagNumber(1)
  $0.ChannelServiceConfig get serviceConfig => $_getN(0);
  @$pb.TagNumber(1)
  set serviceConfig($0.ChannelServiceConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasServiceConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearServiceConfig() => clearField(1);
  @$pb.TagNumber(1)
  $0.ChannelServiceConfig ensureServiceConfig() => $_ensure(0);

  @$pb.TagNumber(2)
  $core.String get intercept => $_getSZ(1);
  @$pb.TagNumber(2)
  set intercept($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasIntercept() => $_has(1);
  @$pb.TagNumber(2)
  void clearIntercept() => clearField(2);
...
class DurationRules extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DurationRules', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'validate'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'required')
    ..aOM<$4.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'const', subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lt', subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lte', subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gt', subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gte', subBuilder: $4.Duration.create)
    ..pc<$4.Duration>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'in', $pb.PbFieldType.PM, subBuilder: $4.Duration.create)
    ..pc<$4.Duration>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notIn', $pb.PbFieldType.PM, subBuilder: $4.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4.Duration get const_2 => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $4.Duration ensureConst_2() => $_ensure(1);

  @$pb.TagNumber(3)
  $4.Duration get lt => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $4.Duration ensureLt() => $_ensure(2);

  @$pb.TagNumber(4)
  $4.Duration get lte => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $4.Duration ensureLte() => $_ensure(3);

  @$pb.TagNumber(5)
  $4.Duration get gt => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $4.Duration ensureGt() => $_ensure(4);

  @$pb.TagNumber(6)
  $4.Duration get gte => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $4.Duration ensureGte() => $_ensure(5);

  @$pb.TagNumber(7)
  $core.List<$4.Duration> get in_7 => $_getList(6);

  @$pb.TagNumber(8)
  $core.List<$4.Duration> get notIn => $_getList(7);
}
...
class TimestampRules extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimestampRules', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'validate'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'required')
    ..aOM<$5.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'const', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lt', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lte', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gt', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gte', subBuilder: $5.Timestamp.create)
    ...
    ..aOM<$4.Duration>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'within', subBuilder: $4.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $5.Timestamp get const_2 => $_getN(1);
  @$pb.TagNumber(2)
  ...
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $5.Timestamp ensureConst_2() => $_ensure(1);

  @$pb.TagNumber(3)
  $5.Timestamp get lt => $_getN(2);
  @$pb.TagNumber(3)
  ...
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $5.Timestamp ensureLt() => $_ensure(2);

  @$pb.TagNumber(4)
  $5.Timestamp get lte => $_getN(3);
  @$pb.TagNumber(4)
  ...
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $5.Timestamp ensureLte() => $_ensure(3);

  @$pb.TagNumber(5)
  $5.Timestamp get gt => $_getN(4);
  @$pb.TagNumber(5)
  ...
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $5.Timestamp ensureGt() => $_ensure(4);

  @$pb.TagNumber(6)
  $5.Timestamp get gte => $_getN(5);
  @$pb.TagNumber(6)
  ...
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $5.Timestamp ensureGte() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $4.Duration ensureWithin() => $_ensure(8);
}

class Validate {
  static final disabled = $pb.Extension<$core.bool>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.MessageOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disabled', 1000, $pb.PbFieldType.OB);
  static final ignored = $pb.Extension<$core.bool>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.MessageOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ignored', 1001, $pb.PbFieldType.OB);
  static final required = $pb.Extension<$core.bool>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.OneofOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'required', 1000, $pb.PbFieldType.OB);
  static final rules = $pb.Extension<FieldRules>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.FieldOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rules', 1000, $pb.PbFieldType.OM, defaultOrMaker: FieldRules.getDefault, subBuilder: FieldRules.create);
