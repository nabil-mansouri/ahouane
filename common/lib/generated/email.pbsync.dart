...
abstract class EmailServiceSync extends $grpc.Service {
  ...
  $1.EmailStatus sendMail_Pre($grpc.ServiceCall call, $1.EmailPayload request) {
    return sendMail(request);
  }

  $1.EmailStatus sendMail($1.EmailPayload request);
}
