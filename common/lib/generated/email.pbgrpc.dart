...
class EmailServiceClient extends $grpc.Client {
  static final _$sendMail = $grpc.ClientMethod<$1.EmailPayload, $1.EmailStatus>(
      '/EmailService/sendMail',
      ($1.EmailPayload value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.EmailStatus.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.EmailStatus> sendMail($1.EmailPayload request,
      {$grpc.CallOptions options}) {
...
abstract class EmailServiceBase extends $grpc.Service {
  ...
  $async.Future<$1.EmailStatus> sendMail(
      $grpc.ServiceCall call, $1.EmailPayload request);
}
