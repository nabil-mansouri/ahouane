...
const MessageOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uninterpreted_option', '3': 999, '4': 3, '5': 11, '6': '.google.protobuf.UninterpretedOption', '10': 'uninterpretedOption'},
    const {'1': 'disabled', '3': 1000, '4': 1, '5': 8, '10': 'disabled'},
    const {'1': 'ignored', '3': 1001, '4': 1, '5': 8, '10': 'ignored'},
  ],
  '5': const [
    const {'1': 1002, '2': 536870912},
  ],
  '9': const [
    const {'1': 8, '2': 9},
    const {'1': 9, '2': 10},
...
final $typed_data.Uint8List messageOptionsDescriptor = $convert.base64Decode('');
...
const FieldOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uninterpreted_option', '3': 999, '4': 3, '5': 11, '6': '.google.protobuf.UninterpretedOption', '10': 'uninterpretedOption'},
    const {'1': 'rules', '3': 1000, '4': 1, '5': 11, '6': '.validate.FieldRules', '10': 'rules'},
  ],
  '4': const [FieldOptions_CType$json, FieldOptions_JSType$json],
  '5': const [
    const {'1': 1001, '2': 536870912},
  ],
  '9': const [
    const {'1': 4, '2': 5},
  ],
...
final $typed_data.Uint8List fieldOptionsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use oneofOptionsDescriptor instead')
const OneofOptions$json = const {
  '1': 'OneofOptions',
  '2': const [
    const {'1': 'uninterpreted_option', '3': 999, '4': 3, '5': 11, '6': '.google.protobuf.UninterpretedOption', '10': 'uninterpretedOption'},
    const {'1': 'required', '3': 1000, '4': 1, '5': 8, '10': 'required'},
  ],
  '5': const [
    const {'1': 1001, '2': 536870912},
  ],
...
final $typed_data.Uint8List oneofOptionsDescriptor = $convert.base64Decode('CgxPbmVvZk9wdGlvbnMSWAoUdW5pbnRlcnByZXRlZF9vcHRpb24Y5wcgAygLMiQuZ29vZ2xlLnByb3RvYnVmLlVuaW50ZXJwcmV0ZWRPcHRpb25SE3VuaW50ZXJwcmV0ZWRPcHRpb24SGwoIcmVxdWlyZWQY6AcgASgIUghyZXF1aXJlZCoJCOkHEICAgIAC');
